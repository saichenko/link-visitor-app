...
* `fab pip_compile_dev` - скомпилировать зависимости для development
* `fab pip_compile_prod` - скомпилировать зависимости для production
...
**Примечание**: при добавлении каких-либо зависимостей в проект или изменении Dockerfile, необходимо пересобрать контейнер с веб-приложением `docker-compose build server` и скомпилировать зависимости.
